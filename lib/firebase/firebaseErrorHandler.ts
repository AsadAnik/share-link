...
export class FirebaseErrorHandler {
  static handle(error: Error | FirebaseAppError | FirebaseAuthError | FirebaseError) {
    if (!(error instanceof FirebaseAppError || error instanceof FirebaseAuthError || error instanceof FirebaseError)) {
      return null;
    }
